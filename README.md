...
running command...
$ mycli (--version)
mycli/0.0.0 darwin-x64 node-v14.19.1
$ mycli --help [COMMAND]
USAGE
  $ mycli COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/13colours/mycli/blob/v0.0.0/dist/commands/hello/index.ts)_
